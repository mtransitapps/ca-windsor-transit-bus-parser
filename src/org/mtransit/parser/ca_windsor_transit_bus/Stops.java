...
public class Stops {
	...
	static {
		...
		allStops.put("1644", "576"); // Lauzon Rd. at Hawthorne
		allStops.put("1646", "577"); // Hawthorne at Sycamore
		allStops.put("1648", "578"); // Meadowbrook at Hawthorne
		allStops.put("1650", "579"); // Meadowbrook at Parkside Estates
		allStops.put("1652", "580"); // Meadowbrook at Optimist Park
		allStops.put("1654", "581"); // Meadowbrook at Essex Way
		allStops.put("1564", "582"); // Seminole at Albert
		allStops.put("1562", "583"); // Seminole at Walker
		allStops.put("1543", "584"); // Giles at Elsmere
		allStops.put("1541", "585"); // Giles at Louis
		allStops.put("1539", "586"); // Giles at Howard
		allStops.put("1536", "587"); // Giles at McDougall
		allStops.put("1534", "588"); // Giles at Windsor
		allStops.put("1532", "589"); // Giles at Ouellette
		allStops.put("2063", "590"); // Giles at Parent
		allStops.put("1546", "591"); // Ottawa at Parent
		allStops.put("1549", "592"); // Ottawa at Pierre
		allStops.put("1551", "593"); // Ottawa at Moy
		allStops.put("1553", "594"); // Ottawa at Gladstone
		allStops.put("1554", "595"); // Ottawa at Lincoln
		allStops.put("1556", "596"); // Ottawa at Kildare
		allStops.put("1559", "597"); // Ottawa at Walker
		allStops.put("1661", "598"); // Walker at Ontario
